"""
Django settings for packet_server project.
...
SECRET_KEY = 'django-insecure-^&etxhys13za!fb2&w!5fi2ulzle=u%rc%4j$v&=1b$_bt#bc%'
...
ROOT_URLCONF = 'packet_server.urls'
...
WSGI_APPLICATION = 'packet_server.wsgi.application'
